...
import static game.Board.PlayerToken.O;
import static game.Board.PlayerToken.X;
...
public class Board {
    ...
    public void placeX(Position pos) {
        board[rowIdx(pos)][colIdx(pos)] = PlayerToken.X;
    }
    ...
    public void placeO(Position pos) {
        board[rowIdx(pos)][colIdx(pos)] = PlayerToken.O;
    }
